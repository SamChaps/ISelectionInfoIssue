...
{
    public sealed partial class GridViewNormal : UserControl
    {
        ...
        public GridViewNormal()
        {
            this.InitializeComponent();

            TheList = new List<string> { "Item1", "Item2", "Item3", "Item4", "Item5", "Item6" };
            ...
            Loaded += GridViewNormal_Loaded;
        }

        private void GridViewNormal_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void ItemCheckbox_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            int index = TheList.IndexOf(checkedItem);
